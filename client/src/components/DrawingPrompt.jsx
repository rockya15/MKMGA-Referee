...
const DRAWING_PROMPTS = [
  ...
  'Draw a car you would steal',
  'Draw what OPCC will be like on release day',
  'Draw a chicken on fire',
  ...
  'Draw capitalism',
  'Draw a wizard who gave up',
  'Draw someone who has never lost a bet',
  'Draw a very sad birthday cake',
  'Draw what regret looks like',
